...
const emptyWitness = () => ({ lastName: '', firstName: '', contactNumber: '', address: '', statement: '' });

export default function WitnessForm({ data = [], onChange }) {
  function add() { onChange([...data, emptyWitness()]); }
  function remove(idx) { onChange(data.filter((_, i) => i !== idx)); }
