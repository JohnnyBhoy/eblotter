...
export default function SuperAdminDashboard() {
  ...
  useEffect(() => {
    Promise.all([
      api.get('/blotters/stats').then(r => r.data).catch(() => null),
      api.get('/users', { params: { limit: 10, page: 1 } }).then(r => r.data).catch(() => ({ users: [] })),
      api.get('/blotters', { params: { limit: 10 } }).then(r => r.data).catch(() => ({ blotters: [] })),
