...
export default function MunicipalDashboard() {
  ...
  return (
    <PageLayout>
      <div className="mb-6">
        <h1 className="text-xl font-bold text-white">Municipal Dashboard</h1>
        <p className="text-xs mt-0.5" style={{ color: '#475569' }}>Municipality-wide blotter overview</p>
      </div>
      ...
      <div className="rounded-2xl p-5" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.07)' }}>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-white">Blotter Records</h2>
          </div>
          <Link to="/municipal/blotters" className="text-xs font-semibold" style={{ color: '#3b82f6' }}>View All →</Link>
        </div>
        <BlotterTable
