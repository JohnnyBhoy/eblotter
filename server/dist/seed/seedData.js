...
const psgc = JSON.parse(readFileSync(join(dirname(fileURLToPath(import.meta.url)), '../data/psgc.json'), 'utf-8'));
    ...
    if (existingBlotters === 0) {
        ...
        for (let i = 0; i < sampleTopics.length; i++) {
            ...
            await Blotter.create({
                ...
                recordedBy: { name: brgyUser['fullName'], position: 'Barangay Secretary' },
                barangayAction: {
